...
import vn.vnpttech.ssdc.nms.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "vn.vnpttech.ssdc.nms.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see vn.vnpttech.ssdc.nms.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
    ...
    public List<User> searchCriteria(UserDisplay searchCriteria){
    	return userDao.searchCriteria(searchCriteria);
    }
