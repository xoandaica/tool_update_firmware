...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see vn.vnpttech.ssdc.nms.service.impl.PasswordTokenManager#generateRecoveryToken(vn.vnpttech.ssdc.nms.model.User)
     */
    @Override
    ...
    /**
     * @see vn.vnpttech.ssdc.nms.service.impl.PasswordTokenManager#isRecoveryTokenValid(vn.vnpttech.ssdc.nms.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see vn.vnpttech.ssdc.nms.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
