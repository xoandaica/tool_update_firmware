...
import vn.vnpttech.ssdc.nms.dao.SearchException;
 ...
 * <pre>
 *      &lt;bean id="fooDao" class="vn.vnpttech.ssdc.nms.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="vn.vnpttech.ssdc.nms.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    public T get(PK id) {
        ...
        System.out.println("Time get session ni save methdo = " + (endTime - startTime));
