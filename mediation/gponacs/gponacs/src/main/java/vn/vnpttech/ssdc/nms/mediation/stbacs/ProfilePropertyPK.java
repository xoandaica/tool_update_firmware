...
public class ProfilePropertyPK {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.ProfilePropertyPK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.ProfilePropertyPK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.ProfilePropertyPK) otherOb;
