...
public interface HardwareModelLocalHome extends EJBLocalHome {
    ...
    vn.vnpttech.ssdc.nms.mediation.stbacs.HardwareModelLocal findByPrimaryKey(java.lang.Object key) throws FinderException;

    vn.vnpttech.ssdc.nms.mediation.stbacs.HardwareModelLocal create(java.lang.Object key) throws CreateException;
