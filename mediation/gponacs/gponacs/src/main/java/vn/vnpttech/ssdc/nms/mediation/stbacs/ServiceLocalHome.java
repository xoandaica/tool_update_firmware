...
public interface ServiceLocalHome extends EJBLocalHome {
    ...
    vn.vnpttech.ssdc.nms.mediation.stbacs.ServiceLocal findByPrimaryKey(Object key) throws FinderException;

    vn.vnpttech.ssdc.nms.mediation.stbacs.ServiceLocal create() throws CreateException;
