...
public abstract class ATMErrorsStatsBean implements EntityBean {
    ...
    public vn.vnpttech.ssdc.nms.mediation.stbacs.ATMErrorsStatsPK ejbCreate(Integer hostid, Timestamp time, int type) throws CreateException {
        setHostid(hostid);
        setTime(time);
        setType(type);
    ...
    public vn.vnpttech.ssdc.nms.mediation.stbacs.ATMErrorsStatsPK ejbCreate(Integer hostid, Timestamp time, int type,
