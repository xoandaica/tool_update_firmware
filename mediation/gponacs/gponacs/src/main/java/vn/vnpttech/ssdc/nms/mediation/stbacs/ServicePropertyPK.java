...
public class ServicePropertyPK {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.ServicePropertyPK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.ServicePropertyPK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.ServicePropertyPK) otherOb;
