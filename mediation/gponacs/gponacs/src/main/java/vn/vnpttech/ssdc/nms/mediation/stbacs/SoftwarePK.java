...
public final class SoftwarePK implements java.io.Serializable {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.SoftwarePK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.SoftwarePK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.SoftwarePK) otherOb;
