...
public class BackupPK {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.BackupPK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.BackupPK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.BackupPK) otherOb;
