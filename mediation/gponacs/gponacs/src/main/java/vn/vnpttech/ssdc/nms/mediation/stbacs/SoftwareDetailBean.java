...
public abstract class SoftwareDetailBean implements EntityBean {
    ...
    // </editor-fold>
    public vn.vnpttech.ssdc.nms.mediation.stbacs.SoftwareDetailPK ejbCreate(Integer hwid, String version, byte[] paramNames, byte[] methods) throws CreateException {
        setHwid(hwid);
        setVersion(version);
