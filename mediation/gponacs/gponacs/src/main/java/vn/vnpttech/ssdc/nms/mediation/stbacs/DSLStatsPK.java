...
public class DSLStatsPK {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.DSLStatsPK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.DSLStatsPK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.DSLStatsPK) otherOb;
