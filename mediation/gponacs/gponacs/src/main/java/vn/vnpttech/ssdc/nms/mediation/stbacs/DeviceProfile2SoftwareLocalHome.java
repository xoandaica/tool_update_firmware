...
public interface DeviceProfile2SoftwareLocalHome extends EJBLocalHome {
    ...
    vn.vnpttech.ssdc.nms.mediation.stbacs.DeviceProfile2SoftwareLocal findByPrimaryKey(DeviceProfile2SoftwarePK key) throws FinderException;

    vn.vnpttech.ssdc.nms.mediation.stbacs.DeviceProfile2SoftwareLocal create(String profileName, Integer hwid, String version) throws CreateException;
