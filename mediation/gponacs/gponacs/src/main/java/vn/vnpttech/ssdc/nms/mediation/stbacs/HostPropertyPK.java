...
public class HostPropertyPK {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.HostPropertyPK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.HostPropertyPK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.HostPropertyPK) otherOb;
