...
public class ConfigurationPK {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.ConfigurationPK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.ConfigurationPK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.ConfigurationPK) otherOb;
