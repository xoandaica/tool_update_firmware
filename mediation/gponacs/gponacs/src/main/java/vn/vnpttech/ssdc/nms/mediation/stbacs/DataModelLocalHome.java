...
public interface DataModelLocalHome extends EJBLocalHome {
    ...
    vn.vnpttech.ssdc.nms.mediation.stbacs.DataModelLocal findByPrimaryKey(java.lang.String key) throws FinderException;

    vn.vnpttech.ssdc.nms.mediation.stbacs.DataModelLocal create(java.lang.String key) throws CreateException;

    public vn.vnpttech.ssdc.nms.mediation.stbacs.DataModelLocal create(java.lang.String name, String type,
