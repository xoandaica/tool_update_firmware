...
public interface ATMErrorsStatsLocalHome extends EJBLocalHome {
    ...
    vn.vnpttech.ssdc.nms.mediation.stbacs.ATMErrorsStatsLocal findByPrimaryKey(vn.vnpttech.ssdc.nms.mediation.stbacs.ATMErrorsStatsPK key) throws FinderException;

    vn.vnpttech.ssdc.nms.mediation.stbacs.ATMErrorsStatsLocal create(Integer hostid, Timestamp time, int type) throws CreateException;

    vn.vnpttech.ssdc.nms.mediation.stbacs.ATMErrorsStatsLocal create(Integer hostid, Timestamp time, int type,
