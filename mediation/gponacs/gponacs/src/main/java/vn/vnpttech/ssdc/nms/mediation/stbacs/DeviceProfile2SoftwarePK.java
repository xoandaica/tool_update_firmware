...
public class DeviceProfile2SoftwarePK {
    ...
    public boolean equals(java.lang.Object otherOb) {
        ...
        if (!(otherOb instanceof vn.vnpttech.ssdc.nms.mediation.stbacs.DeviceProfile2SoftwarePK)) {
            return false;
        }
        vn.vnpttech.ssdc.nms.mediation.stbacs.DeviceProfile2SoftwarePK other = (vn.vnpttech.ssdc.nms.mediation.stbacs.DeviceProfile2SoftwarePK) otherOb;
