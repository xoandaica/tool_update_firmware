...
import vn.vnpttech.ssdc.nms.mediation.stbacs.datamodel.Parameter;
import vn.vnpttech.ssdc.nms.mediation.stbacs.datamodel.Type;
import vn.vnpttech.ssdc.nms.mediation.stbacs.js.Script;
...
import vn.vnpttech.ssdc.nms.mediation.stbacs.message.X_00000C_SetConfiguration;
import vn.vnpttech.ssdc.nms.mediation.stbacs.utils.Ejb;
import vn.vnpttech.ssdc.nms.mediation.stbacs.utils.Version;
import vn.vnpttech.ssdc.nms.mediation.stbacs.vendors.Vendor;
...
//                Timestamp t = new Timestamp(Calendar.getInstance().getTime().getTime());
    ...
    private Long getStat(String b, String type, String name, Map<String, String> v) {
