...
public abstract class DSLStatsBean implements EntityBean {
    ...
    public vn.vnpttech.ssdc.nms.mediation.stbacs.DSLStatsPK ejbCreate(Integer hostid, Timestamp time) throws CreateException {
        if (hostid == null) {
    ...
    public vn.vnpttech.ssdc.nms.mediation.stbacs.DSLStatsPK ejbCreate(Integer hostid, Timestamp time,
