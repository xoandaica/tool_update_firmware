...
//	              , 'Ext.ux.grid.FiltersFeature'
    ...
    var versionUpload = Ext.create('Ext.form.field.Text', {
        xtype: 'textareafield',
        fieldLabel: '<fmt:message key="management.firmware.version"/> *',
        labelAlign: 'top',
        anchor: '97%'
    });
    var modelUpload = Ext.create('Ext.ux.form.field.BoxSelect', {
        fieldLabel: '<fmt:message key="management.firmware.model"/> *',
        labelAlign: 'top',
        emptyText: '<fmt:message key="common.combobox.emptytext"/>',
        anchor: '99%',
    ...
    uploadForm = new Ext.FormPanel({
        ...
        buttons: [{
                ...
                handler: function () {
                    ...
                    {
                        ExtWnms.alertError('Please fill all required fields before upload file!');
                        return;
                    }
                    ...
                    form.submit({
                        ...
                        url: 'uploadFirmware',
                        params: {
                            fwVersion: versionUpload.getRawValue(),
